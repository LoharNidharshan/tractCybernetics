...
<head>
 ...
 <link rel="icon" type="image/x-icon" href="img/logo1.png">
    ...
    <!-- CSS only -->
    <link href="libs/bootstrap-5.1.3-dist/css/bootstrap.min.css"
    rel="stylesheet">
...
<link rel="stylesheet"
    href="libs/L.Control.ZoomBar-master/src/L.Control.ZoomBar.css" />
<script
    src="libs/Leaflet.zoomslider-master/src/L.Control.Zoomslider.js"></script>
<link rel="stylesheet"
    href="libs/Leaflet.zoomslider-master/src/L.Control.Zoomslider.css"
    />

<script
    src="libs/Leaflet.MousePosition-master/src/L.Control.MousePosition.js"></script>
<link rel="stylesheet"
...
<script src="libs/polyline-measure/line-measure.js"></script>
    ...
    <!-- printpdf -->
    <script src="libs/dist/leaflet.browser.print.min.js"></script>
...
<script
    src="https://kartena.github.io/Proj4Leaflet/lib/proj4-compressed.js"></script>
<script
    src="https://kartena.github.io/Proj4Leaflet/src/proj4leaflet.js"></script>
...
<!--<div id="mySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
    ...
    <div id="boxx">
        <li class="nav-item ">
            <a class="nav-link openBtn1 " onclick="openSearch1()" href="#">
                <i class="far fa-search"></i></a>
            <div id="myOverlay1" class="overlay1">
                <span class="closebtn1" onclick="closeSearch1()"
                    title="Close Overlay"> </span>
                <div class="overlay-content1 border-0">
                    <table class="border-0">
                        <td class="border-0">
                            <input type="text" placeholder="Search.."
                                name="search2" id="search">
                            <button class="bg-light border-0 p-3 fw-bold"
                                id="btnData2" type="button"
                                onclick="SearchMe()"><i class="far fa-search"></i></button>
                            <button class="btn-success px-2 border-0"
                                id="btnData1" type="button"
