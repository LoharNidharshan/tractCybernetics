!(function(e) {
  ...
  function(e, t, r) {
    ...
    function n(e, t, r) {
      ...
      n && d(n), o && m(o);
      var i = { type: "Feature" };
      return o && (i.id = o), n && (i.bbox = n), (i.properties =
        t || {}), (i.geometry = e), i;
    }
    function o(e, t, r) {
  ...
  function(e, t, r) {
    ...
    function n(e, t, r) {
      if (null !== e)
        for (
          ...
          (c = m ? e.features[g].geometry : y ? e.geometry : e), (f =
            !!c && "GeometryCollection" === c.type), (u = f
            ? c.geometries.length
            : 1);
          for (var b = 0; b < u; b++) {
            var _ = 0,
    ...
    function o(e, t) {
      ...
      for (r = 0; r < m; r++) {
        for (
          a = h ? e.features[r].geometry : d ? e.geometry : e, l = h
            ...
            ? e.features[r].id
            : d ? e.id : void 0, u =
            !!a && "GeometryCollection" === a.type, s = u
            ? a.geometries.length
            : 1, o = 0;
          o < s;
          o++
  ...
  function(e, t, r) {
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      onAdd: function(e) {
        return (this._map = e), (this._latlngs = []), this._initLayout(), e.on(
          "click",
          this._collapse,
          this
        ), (this._layer = L.layerGroup().addTo(e)), this._container;
      },
      onRemove: function(e) {
      ...
      _initLayout: function() {
        ...
        (t.innerHTML = v({ model: { className: e } })), t.setAttribute(
          "aria-haspopup",
          !0
        ...
        (this.$startPrompt = (0, c.selectOne)(
          ".js-startprompt",
          t
        )), (this.$measuringPrompt = (0, c.selectOne)(
          ".js-measuringprompt",
          t
        )), (this.$startHelp = (0, c.selectOne)(
          ".js-starthelp",
          t
        )), (this.$results = (0, c.selectOne)(
          ".js-results",
          t
        )), (this.$measureTasks = (0, c.selectOne)(
          ".js-measuretasks",
          t
        )), this._collapse(), this._updateMeasureNotStarted(), L.Browser
          .android ||
          (
            L.DomEvent.on(t, "mouseenter", this._expand, this),
            L.DomEvent.on(t, "mouseleave", this._collapse, this)
          ), L.DomEvent.on(r, "click", L.DomEvent.stop), L.Browser.touch
          ? L.DomEvent.on(r, "click", this._expand, this)
          : L.DomEvent.on(r, "focus", this._expand, this), L.DomEvent.on(
          n,
          "click",
          L.DomEvent.stop
        ), L.DomEvent.on(n, "click", this._startMeasure, this), L.DomEvent.on(
          o,
          "click",
          L.DomEvent.stop
        ), L.DomEvent.on(o, "click", this._finishMeasure, this), L.DomEvent.on(
          i,
          "click",
          L.DomEvent.stop
      ...
      _updateMeasureNotStarted: function() {
        f.hide(this.$startHelp), f.hide(this.$results), f.hide(
          this.$measureTasks
        ), f.hide(this.$measuringPrompt), f.show(this.$startPrompt);
      },
      _updateMeasureStartedNoPoints: function() {
        f.hide(this.$results), f.show(this.$startHelp), f.show(
          this.$measureTasks
        ), f.hide(this.$startPrompt), f.show(this.$measuringPrompt);
      },
      _updateMeasureStartedWithPoints: function() {
        f.hide(this.$startHelp), f.show(this.$results), f.show(
          this.$measureTasks
        ), f.hide(this.$startPrompt), f.show(this.$measuringPrompt);
      },
      _startMeasure: function() {
        (this._locked = !0), (this._measureVertexes = L.featureGroup().addTo(
          this._layer
          ...
          this._layer
        )), this._setCaptureMarkerIcon(), this._captureMarker
          .on("mouseout", this._handleMapMouseOut, this)
          .on("dblclick", this._handleMeasureDoubleClick, this)
          .on("click", this._handleMeasureClick, this), this._map
          .on("mousemove", this._handleMeasureMove, this)
          .on("mouseout", this._handleMapMouseOut, this)
          .on("move", this._centerCaptureMarker, this)
          .on("resize", this._setCaptureMarkerIcon, this), L.DomEvent.on(
          this._container,
          "mouseenter",
          this._handleMapMouseOut,
          this
        ), this._updateMeasureStartedNoPoints(), this._map.fire(
          "measurestart",
          null,
          !1
        );
      ...
      _finishMeasure: function() {
        ...
        (this._locked = !1), L.DomEvent.off(
          this._container,
          "mouseover",
          this._handleMapMouseOut,
          this
        ), this._clearMeasure(), this._captureMarker
          ...
          .removeLayer(
            this._captureMarker
          ), (this._measureVertexes = null), this._updateMeasureNotStarted(), this._collapse(), this._map.fire(
          "measurefinish",
          e,
          !1
        );
      ...
      _clearMeasure: function() {
        (this._latlngs = []), (this._resultsModel = null), this._measureVertexes.clearLayers(), this
          ._measureDrag && this._layer.removeLayer(this._measureDrag), this
          ._measureArea && this._layer.removeLayer(this._measureArea), this
          ._measureBoundary &&
      ...
      _handleMeasureDoubleClick: function() {
        ...
        if ((this._finishMeasure(), e.length)) {
          ...
          s &&
            ...
            ), t.addTo(this._layer), t.bindPopup(
            o,
      ...
      _handleMeasureClick: function(e) {
        ...
        (r && t.equals(r)) ||
          ...
          ), this._updateResults(), this._updateMeasureStartedWithPoints();
      },
  ...
  function(e, t, r) {
    function n(e, t, r) {
      ...
      e.replace(C, function(t, r, n, o, i, s) {
        return n ||
          (n = o), (k += e.slice(O, s).replace(_, u)), r && ((j = !0), (k += "' +\n__e(" + r + ") +\n'")), i && ((x = !0), (k += "';\n" + i + ";\n__p += '")), n && (k += "' +\n((__t = (" + n + ")) == null ? '' : __t) +\n'"), (O = s + t.length), t;
      }), (k += "';\n");
      var S = t.variable;
      S || (k = "with (obj) {\n" + k + "\n}\n"), (k = (x ? k.replace(m, "") : k)
        .replace(y, "$1")
    ...
    function n(e) {
      return o(function(t, r) {
        var n = -1,
          ...
          a = o > 2 ? r[2] : void 0;
        for (
          s = e.length > 3 && "function" == typeof s ? (o--, s) : void 0, a &&
            i(r[0], r[1], a) &&
            ((s = o < 3 ? void 0 : s), (o = 1)), t = Object(t);
          ++n < o;
  ...
  function(e, t, r) {
    ...
    (a["[object Float32Array]"] = a["[object Float64Array]"] = a[
      ...
      "[object Uint32Array]"
    ] = !0), (a["[object Arguments]"] = a["[object Array]"] = a[
      "[object ArrayBuffer]"
      ...
      if (f > 2) {
        for (u = 0; u < f; u++)
          u === f - 2
            ...
            : u === f - 1
              ? ((o = f - 1), (i = 0), (s = 1))
              : ((o = u), (i = u + 1), (s = u + 2)), (t = e[o]), (r =
            e[i]), (n = e[s]), (c += (a(n[0]) - a(t[0])) * Math.sin(a(r[1])));
        c = c * l * l / 2;
      }
      return c;
    }
  ...
  function(e, t, r) {
    ...
    function o(e, t) {
      return t || (t = document), Array.prototype.slice.call(
  ...
  function(e, t, r) {
    ...
    function n(e) {
      ...
      return [
        ...
        t ? "" + r + Math.abs(i - s).toFixed(t).slice(2) : ""
      ].join("");
    }
